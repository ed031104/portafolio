import { A as AstroError, j as UnsupportedImageFormat, i as MissingSharp } from './entrypoint_BXACiQyt.mjs';
import { b as baseService, d as detector, p as parseQuality } from './generic_DIB-ho_R.mjs';
...
async function loadSharp() {
  let sharpImport;
  try {
    sharpImport = (await import('./index_D8eHSHq1.mjs').then(n => n.i)).default;
  } catch {
